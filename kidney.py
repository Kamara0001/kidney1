...
import joblib
# reading the dataset as well as turning it into a dataframe
...
#saving the model
joblib.dump(model,r"C:\Users\DAVIDO\Pictures\kidney1\kidney_model.pkl")